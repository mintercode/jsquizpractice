...
var quizData = [{
  ...
  a: "Fight Club",
  b: "Probably Fight Club.",
  c: "You should really consider Fight Club.",
  d: "You should pick Fight Club.",
  correct: "a"
}, {
  ...
  question: "What year was Amazon Established?",
  a: "1996",
  b: "1995",
  c: "1994",
  d: "1997",
...
submitBtn.addEventListener("click", function () {
  ...
  if (answer) {
    ...
    if (currentQuiz < quizData.length) {
      ...
      quiz.innerHTML = "\n                <h2>You answered ".concat(score, "/").concat(quizData.length, " correctly!</h2>\n                \n                <button onclick=\"location.reload()\">Reload</button>\n            ");
    }
  }
});
